...
class ObsDataParser:
    ...
    def get_human_state(self, obs):
        ...
        if num_humans == 0:
            return None
        elif num_humans > self.max_humans:
    ...
    def get_follow_state(self, obs, robot_motion_angle):
        ...
        if len(similar_direction_groups) == 0:
            ...
            follow_pos_in_horizon = np.zeros((self.mpc_horizon, 2))
            follow_vel_in_horizon = np.zeros((self.mpc_horizon, 2))
        ...
        return follow_pos_in_horizon, follow_vel_in_horizon
