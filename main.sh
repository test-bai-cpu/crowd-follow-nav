...
## same code, go back to only train on eth/ucy, use all.json
#### In deepgearc
python3 main.py --group --record --react --exp_name e011_rw100_1_1_react_sfmrobot_c0.5_h7_eth --dset-file datasets.yaml --follow-weight 1 --collision_radius 0.5
python3 main.py --group --record --react --exp_name e011_rw100_1_5_react_sfmrobot_c0.5_h7_eth --dset-file datasets.yaml --follow-weight 5 --collision_radius 0.5
#### In deepgeareast
python3 main.py --group --record --react --exp_name e011_rw100_1_0_react_sfmrobot_c0.5_h7_eth --dset-file datasets.yaml --follow-weight 0 --collision_radius 0.5
python3 main.py --group --record --react --exp_name e011_rw100_1_20_react_sfmrobot_c0.5_h7_eth --dset-file datasets.yaml --follow-weight 20 --collision_radius 0.5
#### In desktop
python3 main.py --group --record --react --exp_name e011_rw100_1_10_react_sfmrobot_c0.5_h7_eth --dset-file datasets.yaml --follow-weight 10 --collision_radius 0.5


## same code, to try to run only on synthetic data now, use synthetic_train8.json
#### In deepgearc
python3 main.py --group --record --react --exp_name e011_rw100_1_1_react_sfmrobot_c0.5_h8_syn --dset-file datasets_syn.yaml --follow-weight 1 --collision_radius 0.5
python3 main.py --group --record --react --exp_name e011_rw100_1_5_react_sfmrobot_c0.5_h8_syn --dset-file datasets_syn.yaml --follow-weight 5 --collision_radius 0.5
#### In deepgeareast
python3 main.py --group --record --react --exp_name e011_rw100_1_0_react_sfmrobot_c0.5_h8_syn --dset-file datasets_syn.yaml --follow-weight 0 --collision_radius 0.5
python3 main.py --group --record --react --exp_name e011_rw100_1_20_react_sfmrobot_c0.5_h8_syn --dset-file datasets_syn.yaml --follow-weight 20 --collision_radius 0.5
#### In desktop
python3 main.py --group --record --react --exp_name e011_rw100_1_10_react_sfmrobot_c0.5_h8_syn --dset-file datasets_syn.yaml --follow-weight 10 --collision_radius 0.5
...
python3 main.py --group --record --react --exp_name e012_rw100_1_0_react_sfmrobot_c0.5_h9_syn --dset-file datasets_syn.yaml --follow-weight 0 --collision_radius 0.5
python3 main.py --group --record --react --exp_name e012_rw100_1_1_react_sfmrobot_c0.5_h9_syn --dset-file datasets_syn.yaml --follow-weight 1 --collision_radius 0.5
python3 main.py --group --record --react --exp_name e012_rw100_1_5_react_sfmrobot_c0.5_h9_syn --dset-file datasets_syn.yaml --follow-weight 5 --collision_radius 0.5
